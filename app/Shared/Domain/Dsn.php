...
class Dsn implements ValueObjectInterface
{
     ...
     *
     * @var null|int<1, 65535>
     * @readonly
     */
    public ?int $port {
        get => $this->parsed->getPort();
    }
